...
class FCBFormer_cbam(nn.Module):
    def __init__(self, size=352, n_classes=2, mode_='None', act_types =['sigmoid'], reduction_ratio=16,alpha=1.0):
        ...
        self.cbam = CBAM( 64, reduction_ratio, act_types, alpha=alpha) # 마지막 conv out_features = 64
